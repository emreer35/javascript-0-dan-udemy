const menu = [
    ...
    },
    {
      ...
      category: "Dessert",
      price: 31.99,
      img: "./images/item-11-kunefe.jpeg",
      desc: `Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident laborum deserunt tenetur hic eaque beatae.`, 
...
document.addEventListener("DOMContentLoaded",function(){
  ...
  const displayButton = menu.reduce((values,item)=>{
  ...
  const filterBtn = displayButton.map((btn)=>{
    return `<button type="button" class="filter-btn" data-id="${btn}">${btn}</button>`
  }).join("")
  btnContainer.innerHTML = filterBtn
